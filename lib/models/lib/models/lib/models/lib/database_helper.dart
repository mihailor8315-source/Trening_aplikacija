...
class DatabaseHelper {
  // Singleton obrazac – samo jedna instanca postoji u cijeloj aplikaciji
  ...
  // Kreira tabele kada se aplikacija prvi put pokrene
  ...
  // Vraća sve vežbe sa određenim imenom, sortirane po datumu
  // – koristimo ovo za prikaz napretka
  Future<List<Map<String, dynamic>>> getProgressForExercise(String exerciseName) async {
    final db = await database;
  ...
  // Vraća listu jedinstvenih naziva vežbi
